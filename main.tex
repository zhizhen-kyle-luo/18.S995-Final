...
The relative agreement of low-rank error and attention perturbation response across transforms (effective rank also agrees within roughly $10\%$) is informative. These quantities depend on the gross spectral envelope and on the structure of $QK^\top$, neither of which is strongly reshaped by a row-by-row map. Row-norm structure, by contrast, is a row-level property and is therefore exactly what most cleanly differentiates LN from DyT in this experiment.
