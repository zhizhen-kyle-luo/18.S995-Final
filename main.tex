...
The final diagnostic is spectral compressibility. If \(M_k\) is the best rank-\(k\) approximation to \(M\), then the Eckart--Young theorem~\cite{eckart1936approximation} gives
\[
    \|M-M_k\|_F^2
    =
...
$\operatorname{err}_{32}(X)$ & $0.336$ & $0.363$ & $0.360$ & $0.372$ & $0.383$ \\
\bottomrule
\end{tabular}
